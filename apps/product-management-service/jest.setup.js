...
beforeEach(() => {
    ...
    process.env.PRODUCT_MANAGEMENT_SERVICE_PORT = '50054';
    ...
    // Other configuration
    process.env.ELASTIC_INDEX = 'test-elastic-index';
    process.env.RAW_DATABASE_URL = 'test-raw-database-url';
    process.env.S3_BUCKET_URL = 'test-s3-bucket-url';
});
