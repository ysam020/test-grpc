// apps/api-gateway-service/__tests__/unit/middlewares/uploadFile.middleware.simple.test.ts

/**
 * Alternative test approach that doesn't rely on internal multer structure
 * This tests the configuration and behavior through a more integrated approach
 */
